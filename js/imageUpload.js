...
const imageUploadModule = (function() {
    ...
    function _handleTextSubmitClick() {
        $('#upload-button-surrogate2').click(function () { // on a click on the button with id 'submit-button-surrogate'
            $('#upload-button-surrogate2').trigger('click');// trigger a click on the real submit button 

        })
    }


    function _handleTextSubmit(state) {
        $('.upload-button-surrogate2').click(function(event) {
            event.preventDefault();
            state.currentPage = 'ingredients';
            render(state);        
        })
    ...
    function renderLandingPage(state) {
        const landingPageContent = `
            <div class="page-container">
                ...
                <button class="upload-button-surrogate2" id="upload-button-surrogate2"><span class="fas fa-keyboard"></span></button>
        ...
        _handleTextSubmitClick();
        _handleTextSubmit(state);
    }
